...
const OUpdateBeautycenterService = (params) => {
    ...
    useEffect(()=>{
        axios.get(`${url}/bcservices/one/${serviceid}/${userid}`)
        .then(res => {
    ...
    const clickSubmit = event => {
        ...
        axios({
            ...
            url: `${url}/bcservices/update/${serviceid}/${userid}`,
            data: {sname,
                price,
                discount,
                discountprice,
...
export default OUpdateBeautycenterService;