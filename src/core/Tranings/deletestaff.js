...
const DeleteBCStaff = (params) =>{
    ...
    const clickSubmit = () => {
        ...
        axios({
            method: 'DELETE',
            url: `${url}/admin/bcstaff/delete/${staffid}/${userid}`,
        })
        .then(response =>{
    ...
    return(
        <Layout>
            ...
            {/* <ToastContainer /> */}
                ...
                <h1 className='text-center m-lg-5'>حذف معلومات الكادر</h1> 
                {deleteAlert()}
                </div></div>
        </Layout>
    )
