...
const DeleteBCServices = (params) =>{
    ...
    const clickSubmit = () => {
        ...
        axios({
            method: 'DELETE',
            url: `${url}/admin/bcservices/delete/${serviceid}/${userid}`,
        })
        .then(response =>{
    ...
    return(
        <Layout>
            ...
            {/* <ToastContainer /> */}
                ...
                <h1 className='text-center m-lg-5'>حذف معلومات الخدمات</h1> 
                {deleteAlert()}
                </div></div>
        </Layout>
    )
...
export default DeleteBCServices
