...
const UpdateBeautycenterContact = (params) => {
    ...
    useEffect(()=>{
        axios.get(`${url}/admin/bccontacts/one/${contactid}/${userid}`)
        .then(res => {
    ...
    const clickSubmit = event => {
        ...
        axios({
            ...
            url: `${url}/admin/bccontacts/update/${contactid}/${userid}`,
...
export default UpdateBeautycenterContact;