...
const UpdateBeautycenterStaff = (params) => {
    ...
    useEffect(()=>{
        axios.get(`${url}/admin/bcstaff/one/${staffid}/${userid}`)
        .then(res => {
    ...
    const clickSubmit = event => {
        ...
        axios({
            ...
            url: `${url}/admin/bcstaff/update/${staffid}/${userid}`,
...
export default UpdateBeautycenterStaff;